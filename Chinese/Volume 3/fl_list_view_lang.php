...
$lang['fl_list_view_0000'] = "功能位置-QR碼打印視圖";
$lang['fl_list_view_0001'] = "打印以下代碼並將其放在您的設備上，QR碼鏈接到功能位置詳細信息頁面以便您可以使用移動設備快速查看每個已標記設備的完整維護歷史記錄";
$lang['fl_list_view_0002'] = "這個功能位置沒有定義兒童";
?>
